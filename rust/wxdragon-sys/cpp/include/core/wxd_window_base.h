...
WXD_EXPORTED void wxd_Window_SetSizer(wxd_Window_t *window, wxd_Sizer_t *sizer,
                                      bool deleteOldSizer);
WXD_EXPORTED void wxd_Window_SetSizerAndFit(wxd_Window_t *window,
                                            wxd_Sizer_t *sizer,
                                            bool deleteOldSizer);
...
WXD_EXPORTED void wxd_Window_SetBackgroundColor(wxd_Window_t *window,
                                                wxd_Colour_t color);
WXD_EXPORTED void wxd_Window_SetMinSize(wxd_Window_t *window, wxd_Size size);
WXD_EXPORTED void wxd_Window_Refresh(wxd_Window_t *window, int eraseBackground,
                                     const wxd_Rect *rect);
WXD_EXPORTED void wxd_Window_SetToolTip(wxd_Window_t *window,
...
WXD_EXPORTED void wxd_Window_SetSizeWithPos(wxd_Window_t *window, int x, int y,
...
WXD_EXPORTED wxd_Point wxd_Window_ClientToScreen(wxd_Window_t *window,
                                                 wxd_Point pt);
WXD_EXPORTED wxd_Point wxd_Window_ScreenToClient(wxd_Window_t *window,
                                                 wxd_Point pt);
...
WXD_EXPORTED char *wxd_Window_GetLabel(
    wxd_Window_t *self); // Caller must free with wxd_free_string
...
WXD_EXPORTED void wxd_Window_SetFont(wxd_Window_t *self,
...
WXD_EXPORTED void wxd_Window_SetBackgroundStyle(wxd_Window_t *window,
                                                int style);
WXD_EXPORTED int wxd_Window_GetBackgroundStyle(wxd_Window_t *window);

// Extra window style functions
WXD_EXPORTED void wxd_Window_SetExtraStyle(wxd_Window_t *window,
                                           int64_t exStyle);
WXD_EXPORTED int64_t wxd_Window_GetExtraStyle(wxd_Window_t *window);

// Color management functions
WXD_EXPORTED void wxd_Window_SetForegroundColor(wxd_Window_t *window,
                                                wxd_Colour_t color);
...
WXD_EXPORTED char *wxd_Window_GetName(
    wxd_Window_t *window); // Caller must free with wxd_free_string

// Window finding functions
WXD_EXPORTED wxd_Window_t *wxd_Window_FindWindowByName(wxd_Window_t *window,
                                                       const char *name);
WXD_EXPORTED wxd_Window_t *wxd_Window_FindWindowById(wxd_Window_t *window,
                                                     int id);

// --- Cursor Management Functions ---
WXD_EXPORTED void wxd_Window_SetCursor(wxd_Window_t *window,
                                       wxd_Cursor_t *cursor);
...
WXD_EXPORTED wxd_Size wxd_Window_GetTextExtent(wxd_Window_t *window,
                                               const char *text);
WXD_EXPORTED void wxd_Window_GetFullTextExtent(wxd_Window_t *window,
                                               const char *text, wxd_Size *size,
                                               int *descent,
...
WXD_EXPORTED void wxd_Window_SetWindowStyle(wxd_Window_t *window,
                                            int64_t style);
WXD_EXPORTED int64_t wxd_Window_GetWindowStyle(wxd_Window_t *window);

// --- Scrolling Functions ---
WXD_EXPORTED void wxd_Window_ShowPosition(wxd_Window_t *window,
                                          int64_t position);
WXD_EXPORTED void wxd_Window_ScrollIntoView(wxd_Window_t *window,
                                            int64_t position, int keyCode);
WXD_EXPORTED bool wxd_Window_IsPositionVisible(wxd_Window_t *window,
                                               int64_t position);
...
// --- Tab Order Functions ---
WXD_EXPORTED void wxd_Window_MoveAfterInTabOrder(wxd_Window_t *window,
                                                 wxd_Window_t *win);
WXD_EXPORTED void wxd_Window_MoveBeforeInTabOrder(wxd_Window_t *window,
                                                  wxd_Window_t *win);
...
WXD_EXPORTED bool wxd_Window_PopupMenu(wxd_Window_t *window, wxd_Menu_t *menu,
                                       const wxd_Point *pos);
